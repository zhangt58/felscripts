...
lambdau = str2num(args{5});%radiator period							[m]
au      = str2num(args{6});%normalized radiator parameter
lo1     = str2num(args{7});%drift legnth before QF1,after chicane,  unit: radiator period
...
lur     = str2num(args{10});%length of radiator, 					unit: radiator period
